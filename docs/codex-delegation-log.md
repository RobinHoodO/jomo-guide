...
| 2026-07-08 | Surface 69 grid-less events on Map ("No fixed location" collapsible list) | codex×1 | shipped | build + Playwright (69 count, collapsed→expand reveals 69 cards across 10 day pills) | — |
